...
type AccountRegCdkStackProps struct {
	awscdk.StackProps
}

func NewAccountRegCdkStack(scope constructs.Construct, id string, props *AccountRegCdkStackProps) awscdk.Stack {
...
func main() {
	...
	NewAccountRegCdkStack(app, "AccountRegCdkStack", &AccountRegCdkStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
